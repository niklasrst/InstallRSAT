<#
    ...
    .DESCRIPTION
    Install:   PowerShell.exe -ExecutionPolicy Bypass -Command .\W10_InstallRSAT.ps1 -install
    Uninstall:   PowerShell.exe -ExecutionPolicy Bypass -Command .\W10_InstallRSAT.ps1 -uninstall
...
if ($install)
{
	...
	{          
        ...
        New-Item C:\RSAT -ItemType Directory -Force
    }
	catch
	{
...
if ($uninstall)
{
	try
	{
        ...
        Remove-Item C:\RSAT -Recurse -Force
	}
	catch
	{
		$PSCmdlet.WriteError($_)
